  ...
  var describeComponentFactory = function (componentReference, specDefinitions) {
    return function () {
      beforeEach(function (done) {
        ...
        var requireCallback;
        if (isWebpack) {
          requireCallback = function (registry) {
            registry.reset();
            this.Component = componentReference;
            done();
          }.bind(this);

          requireCallback(require('flight/lib/registry'));

        } else {
          requireCallback = function (registry, Component) {
            registry.reset();
      ...
      afterEach(function (done) {
        ...
        if (isWebpack) {
          ...
          requireCallback(require('flight/lib/component'));
  ...
  var describeMixinFactory = function (mixinReference, specDefinitions) {
    return function () {
      beforeEach(function (done) {
        ...
        var requireCallback;
        if (isWebpack) {
          requireCallback = function (registry, defineComponent) {
            registry.reset();
            this.Component = defineComponent(function () {}, mixinReference);
            done();
          }.bind(this);

          requireCallback(require('flight/lib/registry'), require('flight/lib/component'));

        } else {
          requireCallback = function (registry, defineComponent, Mixin) {
            registry.reset();
