  ...
  var describeComponentFactory = function (componentReference, specDefinitions) {
    return function () {
      beforeEach(function (done) {
        ...
        var requireCallback;
        if (isWebpack) {
          requireCallback = function (flight) {
            flight.registry.reset();
            this.Component = componentReference;
            done();
          }.bind(this);

          requireCallback(require('flight'));
        } else {
          requireCallback = function (flight, Component) {
            flight.registry.reset();
            this.Component = Component;
            done();
          }.bind(this);

          require(['flight', componentReference], requireCallback);
        }
      });
    ...
    return function () {
      beforeEach(function (done) {
        ...
        if (isWebpack) {
          requireCallback = function (flight) {
            flight.registry.reset();
            this.Component = flight.component(function () {}, mixinReference);
            done();
          }.bind(this);

          requireCallback(require('flight'));
        } else {
          requireCallback = function (flight, Mixin) {
            flight.registry.reset();
            this.Component = flight.component(function () {}, Mixin);
            done();
          }.bind(this);

          require(['flight', mixinReference], requireCallback);
        }
      });
